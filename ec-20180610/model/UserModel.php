...
class UserModel
{
    ...
    public function findByUserId($userId)
    {
        $result = array();
        // 指定するIDの商品を取得
        $sql = 'SELECT user_id, password,name,tel,postal_code,prefecture,adress1,adress2 FROM users WHERE user_id=?';
    ...
    {
        // SQL文
        $sql = 'UPDATE user SET status=1,update_datetime=NOW() WHERE item_id=?';
